...
class BaiduRest:
    ...
    def getText(self, filename):
        ...
        print '2222222'+filename
        voice_data = wav_fp.read()
        print '333333333333333'+filename
        data['len'] = len(voice_data)
        print '444444444444444'+filename
        data['speech'] = base64.b64encode(voice_data).decode('utf-8')
        print '5555555555555555'+filename
        post_data = json.dumps(data)
        print '666666666666'+filename
        r=requests.post(self.upvoice_url,data=bytes(post_data))
        # 3.处理返回数据
        print r.text
        return r.text
...
if __name__ == "__main__":
    ...
    api_key = "N1TlmdH5pou8fMkcQYF5iNWy" 
    api_secert = "Xb5i3uflCf9dGavs6kdTPXtHIc1Pdgwh"
    # 初始化
